        ...
        >
          ...
          <div className="space-y-4">
            <div>
              ...
              <p>
                Enthusiastic Full Stack Developer with 2+ years of experience in
                building scalable web apps and a strong presence in open-source
                contributions.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc ml-6 space-y-1">
                <li>
                  Software Developer Intern @ ABC Corp (Jan 2024 - Jun 2024)
                </li>
            ...
            <div>
              ...
              <ul className="list-disc ml-6 space-y-1">
                <li>
                  B.Tech in Computer Science, IIIT Bhubaneswar (2022–2026)
                </li>
              </ul>
            </div>
